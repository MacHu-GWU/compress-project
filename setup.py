...
if __name__ == "__main__":
    ...
    EXTRA_REQUIRE["lz4"] = read_requirements_file("requirements-algo-lz4.txt")
    EXTRA_REQUIRE["snappy"] = read_requirements_file("requirements-algo-snappy.txt")
    EXTRA_REQUIRE["zstd"] = read_requirements_file("requirements-algo-zstd.txt")
