# -*- coding: utf-8 -*-
#
# compress documentation build configuration file, created by
...
version = compress.__version__
# The full version, including alpha/beta/rc tags.
release = compress.__version__
...
html_logo = "./_static/compress-logo.png"
html_favicon = "./_static/compress-favicon.ico"
...
latex_documents = [
    (master_doc, 'compress.tex', 'compress Documentation',
     u'Sanhe Hu', 'manual'),
]
...
man_pages = [
    (master_doc, 'compress', 'compress Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'compress', 'compress Documentation',
     author, 'compress', 'One line description of project.',
     'Miscellaneous'),
]
...
# Add data for Jinja2
try:
    from compress.docs import doc_data
except:
    doc_data = dict()
...
package_name = compress.__name__
